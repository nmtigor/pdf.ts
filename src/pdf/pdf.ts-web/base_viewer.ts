...
import {
  ...
  RendererType, RenderingStates, SCROLLBAR_PADDING,
  scrollIntoView,
  ScrollMode,
  SpreadMode,
  TextLayerMode,
  UNKNOWN_SCALE,
  VERTICAL_PADDING, watchScroll, type VisibleElement,
  ...
  IPDFXfaLayerFactory
{
  ...
  #scrollIntoView( pageView:_PageView, pageSpot:PageSpot | undefined=undefined )
  {

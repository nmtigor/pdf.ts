...
import { normalizeUnicode, TextLayer } from "../pdf.ts-src/pdf.ts";
...
export class TextLayerBuilder {
  ...
  static #selectionChangeAbortController: AbortController | undefined;
   ...
   */
  async render(viewport: PageViewport, textContentParams?: GetTextContentP) {
  ...
  static #enableGlobalSelectionListener() {
    ...
    /*#static*/ if (PDFJSDev || !MOZCENTRAL) {
      ...
      var isFirefox: boolean | undefined, prevRange: Range | undefined;
    }

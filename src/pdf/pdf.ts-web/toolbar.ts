...
export class Toolbar {
  ...
  #bindListeners(buttons: Button[]) {
    ...
    scaleSelect.on("click", function (this: HTMLSelectElement, { target }) {
  ...
  #editorModeChanged({ mode }: EventMap["annotationeditormodechanged"]) {
    const {
  ...
  #updateUIState = (resetNumPages = false) => {
    ...
    if (resetNumPages) {
      ...
      opts.pageNumber.max = pagesCount as any;
    }
    ...
    if (this.hasPageLabels) {
      ...
      opts.pageNumber.value = pageNumber as any;
    }

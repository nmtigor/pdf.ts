...
export abstract class Pattern
{
  ...
  static parseShading(
    ...
    const type = <ShadingType>dict.get("ShadingType");
...
export type RadialAxialIR = [ "RadialAxial", ...[
...
export type ShadingPatternIR =
  | RadialAxialIR
  | MeshIR
  | DummyIR
;

export type TilingPatternIR = [ "TilingPattern", ...[
  ...
  constructor(
    ...
    switch( this.shadingType )
    {
      case ShadingType.FREE_FORM_MESH:
        ...
        break;
      case ShadingType.LATTICE_FORM_MESH:
        const verticesPerRow = <any>dict.get("VerticesPerRow") | 0;
        if (verticesPerRow < 2) {

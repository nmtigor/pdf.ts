...
import { getArrayLookupTableFactory } from "./core_utils.ts";
/*80--------------------------------------------------------------------------*/
...
export const getGlyphsUnicode = getArrayLookupTableFactory(() => [
  ...
  0x3124,
  "angbracketleft",
  0x3008, // Glyph is missing from Adobe's original list.
  "angbracketright",
  0x3009, // Glyph is missing from Adobe's original list.
  "angkhankhuthai",
  0x0e5a,
  "angle",
  0x2220,
  ...
  0x25cb,
  "circlecopyrt",
  0x00a9, // Glyph is missing from Adobe's original list.
  "circlemultiply",
  0x2297,
  "circleot",
  0x2299,
  ...
  0x0015,
  "controlNULL",
  0x0000, // Glyph is missing from Adobe's original list.
  "controlRS",
  0x001e,
  "controlSI",
  0x000f,

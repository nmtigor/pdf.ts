...
export class Catalog
{
    ...
    try {
      ...
      for( const groupRef of groupsData )
      {
        ...
        groups.push({
          ...
          name: 
            typeof (v = group.get("Name")) == "string"
              ? stringToPDFString( v )
              : null,
          intent: 
            typeof (v = group.get("Intent")) === "string"
              ? stringToPDFString( v )
              : null,
        });
      }
  ...
  #readOptionalContentConfig( config:Dict, contentGroupRefs:Ref[] )
  {
    ...
    return {
      name: 
        typeof (v = config.get("Name")) === "string"
          ? stringToPDFString( v )
          : null,
      creator: 
        typeof (v = config.get("Creator")) === "string"
          ? stringToPDFString( v )
          : null,
      baseState: 
        (v = config.get("BaseState")) instanceof Name
          ? v.name
          : null,

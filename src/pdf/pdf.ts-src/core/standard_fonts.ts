...
export const getSerifFonts = getLookupTableFactory( ( t:Record<string,boolean> ) =>
{
  t["Adobe Jenson"] = true;
  t["Adobe Text"] = true;
  t.Albertus = true;
...
export const getSymbolsFonts = getLookupTableFactory( ( t:Record<string,boolean> ) =>
{
  t.Dingbats = true;
  t.Symbol = true;
  t.ZapfDingbats = true;
...
export const getSupplementalGlyphMapForArialBlack = 
  getLookupTableFactory( ( t:Record<number,number> ) =>
{
  t[227] = 322;
  t[264] = 261;
  t[291] = 346;
...
export const getSupplementalGlyphMapForCalibri = 
  getLookupTableFactory( ( t:Record<number,number> ) =>
{
  t[1] = 32;
  t[4] = 65;

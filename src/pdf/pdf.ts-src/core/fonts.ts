...
import { CMap, IdentityCMap, type CharCodeOut } from "./cmap.js";
...
function buildToFontChar( encoding:string[], 
  glyphsUnicodeMap:Record<string, number>, differences?:string[] )
{
  const toFontChar = [];
  let unicode;

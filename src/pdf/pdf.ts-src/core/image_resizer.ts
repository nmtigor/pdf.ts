...
import { FeatureTest, ImageKind, shadow } from "../shared/util.ts";
...
export class ImageResizer {
  ...
  static async createImage(imgData: ImgData, isMask = false) {
  ...
  _encodeBMP() {
    ...
    let data = this._imgData.data as Uint8Array | Uint8ClampedArray;
    let bitPerPixel;

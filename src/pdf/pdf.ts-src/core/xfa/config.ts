...
export const ConfigNamespace =
{
  ...
  acrobat( attrs:XFAAttrs ) { return new Acrobat(attrs); },
  acrobat7( attrs:XFAAttrs ) { return new Acrobat7(attrs); },
  ADBE_JSConsole( attrs:XFAAttrs ) { return new ADBE_JSConsole(attrs); },
  ADBE_JSDebugger( attrs:XFAAttrs ) { return new ADBE_JSDebugger(attrs); },
  addSilentPrint( attrs:XFAAttrs ) { return new AddSilentPrint(attrs); },
  addViewerPreferences( attrs:XFAAttrs ) { return new AddViewerPreferences(attrs); },
  adjustData( attrs:XFAAttrs ) { return new AdjustData(attrs); },
  adobeExtensionLevel( attrs:XFAAttrs ) { return new AdobeExtensionLevel(attrs); },
  agent( attrs:XFAAttrs ) { return new Agent(attrs); },
  alwaysEmbed( attrs:XFAAttrs ) { return new AlwaysEmbed(attrs); },
  amd( attrs:XFAAttrs ) { return new Amd(attrs); },
  area( attrs:XFAAttrs ) { return new Area(attrs); },
  attributes( attrs:XFAAttrs ) { return new Attributes(attrs); },
  autoSave( attrs:XFAAttrs ) { return new AutoSave(attrs); },
  base( attrs:XFAAttrs ) { return new Base(attrs); },
  batchOutput( attrs:XFAAttrs ) { return new BatchOutput(attrs); },
  behaviorOverride( attrs:XFAAttrs ) { return new BehaviorOverride(attrs); },
  cache( attrs:XFAAttrs ) { return new Cache(attrs); },
  change( attrs:XFAAttrs ) { return new Change(attrs); },
  common( attrs:XFAAttrs ) { return new Common(attrs); },
  compress( attrs:XFAAttrs ) { return new Compress(attrs); },
  compressLogicalStructure( attrs:XFAAttrs ) { return new CompressLogicalStructure(attrs); },
  compressObjectStream( attrs:XFAAttrs ) { return new CompressObjectStream(attrs); },
  compression( attrs:XFAAttrs ) { return new Compression(attrs); },
  config( attrs:XFAAttrs ) { return new Config(attrs); },
  conformance( attrs:XFAAttrs ) { return new Conformance(attrs); },
  contentCopy( attrs:XFAAttrs ) { return new ContentCopy(attrs); },
  copies( attrs:XFAAttrs ) { return new Copies(attrs); },
  creator( attrs:XFAAttrs ) { return new Creator(attrs); },
  currentPage( attrs:XFAAttrs ) { return new CurrentPage(attrs); },
  data( attrs:XFAAttrs ) { return new Data(attrs); },
  debug( attrs:XFAAttrs ) { return new Debug(attrs); },
  defaultTypeface( attrs:XFAAttrs ) { return new DefaultTypeface(attrs); },
  destination( attrs:XFAAttrs ) { return new Destination(attrs); },
  documentAssembly( attrs:XFAAttrs ) { return new DocumentAssembly(attrs); },
  driver( attrs:XFAAttrs ) { return new Driver(attrs); },
  duplexOption( attrs:XFAAttrs ) { return new DuplexOption(attrs); },
  dynamicRender( attrs:XFAAttrs ) { return new DynamicRender(attrs); },
  embed( attrs:XFAAttrs ) { return new Embed(attrs); },
  encrypt( attrs:XFAAttrs ) { return new Encrypt(attrs); },
  encryption( attrs:XFAAttrs ) { return new Encryption(attrs); },
  encryptionLevel( attrs:XFAAttrs ) { return new EncryptionLevel(attrs); },
  enforce( attrs:XFAAttrs ) { return new Enforce(attrs); },
  equate( attrs:XFAAttrs ) { return new Equate(attrs); },
  equateRange( attrs:XFAAttrs ) { return new EquateRange(attrs); },
  exclude( attrs:XFAAttrs ) { return new Exclude(attrs); },
  excludeNS( attrs:XFAAttrs ) { return new ExcludeNS(attrs); },
  flipLabel( attrs:XFAAttrs ) { return new FlipLabel(attrs); },
  fontInfo( attrs:XFAAttrs ) { return new FontInfo(attrs); },
  formFieldFilling( attrs:XFAAttrs ) { return new FormFieldFilling(attrs); },
  groupParent( attrs:XFAAttrs ) { return new GroupParent(attrs); },
  ifEmpty( attrs:XFAAttrs ) { return new IfEmpty(attrs); },
  includeXDPContent( attrs:XFAAttrs ) { return new IncludeXDPContent(attrs); },
  incrementalLoad( attrs:XFAAttrs ) { return new IncrementalLoad(attrs); },
  incrementalMerge( attrs:XFAAttrs ) { return new IncrementalMerge(attrs); },
  interactive( attrs:XFAAttrs ) { return new Interactive(attrs); },
  jog( attrs:XFAAttrs ) { return new Jog(attrs); },
  labelPrinter( attrs:XFAAttrs ) { return new LabelPrinter(attrs); },
  layout( attrs:XFAAttrs ) { return new Layout(attrs); },
  level( attrs:XFAAttrs ) { return new Level(attrs); },
  linearized( attrs:XFAAttrs ) { return new Linearized(attrs); },
  locale( attrs:XFAAttrs ) { return new Locale(attrs); },
  localeSet( attrs:XFAAttrs ) { return new LocaleSet(attrs); },
  log( attrs:XFAAttrs ) { return new Log(attrs); },
  map( attrs:XFAAttrs ) { return new MapElement(attrs); },
  mediumInfo( attrs:XFAAttrs ) { return new MediumInfo(attrs); },
  message( attrs:XFAAttrs ) { return new Message(attrs); },
  messaging( attrs:XFAAttrs ) { return new Messaging(attrs); },
  mode( attrs:XFAAttrs ) { return new Mode(attrs); },
  modifyAnnots( attrs:XFAAttrs ) { return new ModifyAnnots(attrs); },
  msgId( attrs:XFAAttrs ) { return new MsgId(attrs); },
  nameAttr( attrs:XFAAttrs ) { return new NameAttr(attrs); },
  neverEmbed( attrs:XFAAttrs ) { return new NeverEmbed(attrs); },
  numberOfCopies( attrs:XFAAttrs ) { return new NumberOfCopies(attrs); },
  openAction( attrs:XFAAttrs ) { return new OpenAction(attrs); },
  output( attrs:XFAAttrs ) { return new Output(attrs); },
  outputBin( attrs:XFAAttrs ) { return new OutputBin(attrs); },
  outputXSL( attrs:XFAAttrs ) { return new OutputXSL(attrs); },
  overprint( attrs:XFAAttrs ) { return new Overprint(attrs); },
  packets( attrs:XFAAttrs ) { return new Packets(attrs); },
  pageOffset( attrs:XFAAttrs ) { return new PageOffset(attrs); },
  pageRange( attrs:XFAAttrs ) { return new PageRange(attrs); },
  pagination( attrs:XFAAttrs ) { return new Pagination(attrs); },
  paginationOverride( attrs:XFAAttrs ) { return new PaginationOverride(attrs); },
  part( attrs:XFAAttrs ) { return new Part(attrs); },
  pcl( attrs:XFAAttrs ) { return new Pcl(attrs); },
  pdf( attrs:XFAAttrs ) { return new Pdf(attrs); },
  pdfa( attrs:XFAAttrs ) { return new Pdfa(attrs); },
  permissions( attrs:XFAAttrs ) { return new Permissions(attrs); },
  pickTrayByPDFSize( attrs:XFAAttrs ) { return new PickTrayByPDFSize(attrs); },
  picture( attrs:XFAAttrs ) { return new Picture(attrs); },
  plaintextMetadata( attrs:XFAAttrs ) { return new PlaintextMetadata(attrs); },
  presence( attrs:XFAAttrs ) { return new Presence(attrs); },
  present( attrs:XFAAttrs ) { return new Present(attrs); },
  print( attrs:XFAAttrs ) { return new Print(attrs); },
  printHighQuality( attrs:XFAAttrs ) { return new PrintHighQuality(attrs); },
  printScaling( attrs:XFAAttrs ) { return new PrintScaling(attrs); },
  printerName( attrs:XFAAttrs ) { return new PrinterName(attrs); },
  producer( attrs:XFAAttrs ) { return new Producer(attrs); },
  ps( attrs:XFAAttrs ) { return new Ps(attrs); },
  range( attrs:XFAAttrs ) { return new Range(attrs); },
  record( attrs:XFAAttrs ) { return new Record(attrs); },
  relevant( attrs:XFAAttrs ) { return new Relevant(attrs); },
  rename( attrs:XFAAttrs ) { return new Rename(attrs); },
  renderPolicy( attrs:XFAAttrs ) { return new RenderPolicy(attrs); },
  runScripts( attrs:XFAAttrs ) { return new RunScripts(attrs); },
  script( attrs:XFAAttrs ) { return new Script(attrs); },
  scriptModel( attrs:XFAAttrs ) { return new ScriptModel(attrs); },
  severity( attrs:XFAAttrs ) { return new Severity(attrs); },
  silentPrint( attrs:XFAAttrs ) { return new SilentPrint(attrs); },
  staple( attrs:XFAAttrs ) { return new Staple(attrs); },
  startNode( attrs:XFAAttrs ) { return new StartNode(attrs); },
  startPage( attrs:XFAAttrs ) { return new StartPage(attrs); },
  submitFormat( attrs:XFAAttrs ) { return new SubmitFormat(attrs); },
  submitUrl( attrs:XFAAttrs ) { return new SubmitUrl(attrs); },
  subsetBelow( attrs:XFAAttrs ) { return new SubsetBelow(attrs); },
  suppressBanner( attrs:XFAAttrs ) { return new SuppressBanner(attrs); },
  tagged( attrs:XFAAttrs ) { return new Tagged(attrs); },
  template( attrs:XFAAttrs ) { return new Template(attrs); },
  templateCache( attrs:XFAAttrs ) { return new TemplateCache(attrs); },
  threshold( attrs:XFAAttrs ) { return new Threshold(attrs); },
  to( attrs:XFAAttrs ) { return new To(attrs); },
  trace( attrs:XFAAttrs ) { return new Trace(attrs); },
  transform( attrs:XFAAttrs ) { return new Transform(attrs); },
  type( attrs:XFAAttrs ) { return new Type(attrs); },
  uri( attrs:XFAAttrs ) { return new Uri(attrs); },
  validate( attrs:XFAAttrs ) { return new Validate(attrs); },
  validateApprovalSignatures( attrs:XFAAttrs ) { return new ValidateApprovalSignatures(attrs); },
  validationMessaging( attrs:XFAAttrs ) { return new ValidationMessaging(attrs); },
  version( attrs:XFAAttrs ) { return new Version(attrs); },
  versionControl( attrs:XFAAttrs ) { return new VersionControl(attrs); },
  viewerPreferences( attrs:XFAAttrs ) { return new ViewerPreferences(attrs); },
  webClient( attrs:XFAAttrs ) { return new WebClient(attrs); },
  whitespace( attrs:XFAAttrs ) { return new Whitespace(attrs); },
  window( attrs:XFAAttrs ) { return new Window(attrs); },
  xdc( attrs:XFAAttrs ) { return new Xdc(attrs); },
  xdp( attrs:XFAAttrs ) { return new Xdp(attrs); },
  xsl( attrs:XFAAttrs ) { return new Xsl(attrs); },
  zpl( attrs:XFAAttrs ) { return new Zpl(attrs); },
}
/*81---------------------------------------------------------------------------*/

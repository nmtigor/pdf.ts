 ...
 *
 * @module pdf/pdf.ts-src/core/xfa/formcalc_lexer.ts
 * @license Apache-2.0
 ******************************************************************************/
...
namespace NsSingletons {
  export const obj: Record<TokenName, Token> = Object.create(null);
...
export class Lexer {
  ...
  getIdentifier() {
    ...
    const lower = <TokenName> identifier.toLowerCase();

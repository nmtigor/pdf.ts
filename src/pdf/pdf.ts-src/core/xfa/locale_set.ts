...
export const LocaleSetNamespace =
{
  ...
  calendarSymbols( attrs:XFAAttrs ) { return new CalendarSymbols(attrs); },
  currencySymbol( attrs:XFAAttrs ) { return new CurrencySymbol(attrs); },
  currencySymbols( attrs:XFAAttrs ) { return new CurrencySymbols(attrs); },
  datePattern( attrs:XFAAttrs ) { return new DatePattern(attrs); },
  datePatterns( attrs:XFAAttrs ) { return new DatePatterns(attrs); },
  dateTimeSymbols( attrs:XFAAttrs ) { return new DateTimeSymbols(attrs); },
  day( attrs:XFAAttrs ) { return new Day(attrs); },
  dayNames( attrs:XFAAttrs ) { return new DayNames(attrs); },
  era( attrs:XFAAttrs ) { return new Era(attrs); },
  eraNames( attrs:XFAAttrs ) { return new EraNames(attrs); },
  locale( attrs:XFAAttrs ) { return new Locale(attrs); },
  localeSet( attrs:XFAAttrs ) { return new LocaleSet(attrs); },
  meridiem( attrs:XFAAttrs ) { return new Meridiem(attrs); },
  meridiemNames( attrs:XFAAttrs ) { return new MeridiemNames(attrs); },
  month( attrs:XFAAttrs ) { return new Month(attrs); },
  monthNames( attrs:XFAAttrs ) { return new MonthNames(attrs); },
  numberPattern( attrs:XFAAttrs ) { return new NumberPattern(attrs); },
  numberPatterns( attrs:XFAAttrs ) { return new NumberPatterns(attrs); },
  numberSymbol( attrs:XFAAttrs ) { return new NumberSymbol(attrs); },
  numberSymbols( attrs:XFAAttrs ) { return new NumberSymbols(attrs); },
  timePattern( attrs:XFAAttrs ) { return new TimePattern(attrs); },
  timePatterns( attrs:XFAAttrs ) { return new TimePatterns(attrs); },
  typeFace( attrs:XFAAttrs ) { return new TypeFace(attrs); },
  typeFaces( attrs:XFAAttrs ) { return new TypeFaces(attrs); },
}
/*81---------------------------------------------------------------------------*/

...
export interface Wretch<Self = unknown, Chain = unknown, Resolver = undefined> {
  ...
  _catchers: Map<
    ...
    (error: WretchError, originalRequest: Wretch<Self, Chain, Resolver>) => void
  >;
  /**
   * @private @internal
   */
  _resolvers: ((
    resolver: Resolver extends undefined
      ? Chain & WretchResponseChain<Self, Chain>
      : Resolver,
    originalRequest: Wretch<Self, Chain, Resolver>,
  ) => any)[];
  /**
   * @private @internal
   */
  ...
  ): W & Self & Wretch<Self & W, Chain & R, Resolver>;
  /**
  ...
  polyfills(
    ...
    polyfills: Partial<Config["polyfills"]>,
    replace?: boolean,
  ): this;
  /**
...
export interface WretchResponseChain<T, Self = unknown, R = undefined> {
  ...
  res: <Result = WretchResponse>(
    cb?: (type: WretchResponse) => Promise<Result> | Result,
   ...
   */
  json: <Result = unknown>(
    cb?: (type: any) => Promise<Result> | Result,
  ) => Promise<Awaited<Result>>;
  /**
   ...
   */
  blob: <Result = Blob>(
    cb?: (type: Blob) => Promise<Result> | Result,
  ) => Promise<Awaited<Result>>;
  /**
  ...
  formData: <Result = FormData>(
    cb?: (type: FormData) => Promise<Result> | Result,
  ) => Promise<Awaited<Result>>;
  /**
  ...
  arrayBuffer: <Result = ArrayBuffer>(
    cb?: (type: ArrayBuffer) => Promise<Result> | Result,
  ) => Promise<Awaited<Result>>;
  /**
   ...
   */
  text: <Result = string>(
    cb?: (type: string) => Promise<Result> | Result,
  ) => Promise<Awaited<Result>>;
  /**
   ...
   */
  error: (
    this: Self & WretchResponseChain<T, Self, R>,
    code: number | string | symbol,
    cb: WretchErrorCallback<T, Self, R>,
  ) => this;
  /**
 ...
 */
export type WretchErrorCallback<T, C, R> = (
  error: WretchError,
  originalRequest: T & Wretch<T, C, R>,
) => any;
/**
 ...
 */
export type WretchDeferredCallback<T, C, R> = (

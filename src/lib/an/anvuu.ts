  ...
  extends HTMLVuu<C, E>
{
  ...
  /** @final */
  init() { this.anval = this.anmin$; }
  fina() { this.anval = this.anmax$; }

  /** 
   * @final 
   * @param { const } ratio_x
   */
  setByRatio( ratio_x:Ratio ) { this.anval = this.anmin$ + this.delta$ * ratio_x; }
}
...
export class TransX extends HTMLAnvuu
{
  ...
  set x0dx( val_x:number ) { this.x0 = val_x; this.dx = this.x1 - val_x; }
  set x1dx( val_x:number ) { this.x1 = val_x; this.dx = val_x - this.x0; }
...
export class Translate extends HTMLAnvuu
{
  ...
  set x0dx( val_x:number ) { this.x0 = val_x; this.dx = this.x1 - val_x; }
  set x1dx( val_x:number ) { this.x1 = val_x; this.dx = val_x - this.x0; }
  set y0dy( val_x:number ) { this.y0 = val_x; this.dy = this.y1 - val_x; }
  set y1dy( val_x:number ) { this.y1 = val_x; this.dy = val_x - this.y0; }
...
export class Transwidt extends HTMLAnvuu
{
  ...
  set w0dw( val_x:number ) { this.w0 = val_x; this.dw = this.w1 - val_x; }
  set w1dw( val_x:number ) { this.w1 = val_x; this.dw = val_x - this.w0; }
...
export class Transhigt extends HTMLAnvuu
{
  ...
  set h0dh( val_x:number ) { this.h0 = val_x; this.dh = this.h1 - val_x; }
  set h1dh( val_x:number ) { this.h1 = val_x; this.dh = val_x - this.h0; }
...
export class Transopac extends HTMLAnvuu
{
  ...
  set a0da( val_x:number ) { this.a0 = val_x; this.da = this.a1 - val_x; }
  set a1da( val_x:number ) { this.a1 = val_x; this.da = val_x - this.a0; }

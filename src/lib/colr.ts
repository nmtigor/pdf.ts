...
import { Ratio, uint8 } from "./alias.ts";
...
export type X_t =
  CsscHex; /** normalized CsscHex, i.e., "#12abc6" or "#12abc678" */
...
export function hexcolr(hexstr: CsscHex) {
  return new Colr("hex", hexstr);
}
export function rgb(r: R_t, g: G_t, b: B_t) {
  return new Colr("rgb", r, g, b);
}
export function rgba(r: R_t, g: G_t, b: B_t, a: A_t) {
  return new Colr("rgba", r, g, b, a);
}
export function hsl(h: H_t, s: S_t, l: L_t) {
  return new Colr("hsl", h, s, l);
}
export function hsla(h: H_t, s: S_t, l: L_t, a: A_t) {
  return new Colr("hsla", h, s, l, a);
}
export function csscname(cn: CsscName) {

...
export const ScaleHow = Object.freeze({
    proportional: 0,
    anamorphic: 1,
});
export const ScaleWhen = Object.freeze({
    always: 0,
    never: 1,
    tooBig: 2,
    tooSmall: 3,
...
export const Trans = Object.freeze({
...
export const GlobalConstants = Object.freeze({
    ...
    IDS_AM: "am",
    IDS_PM: "pm",
    IDS_MONTH_INFO: "January[1] February[2] March[3] April[4] May[5] " +

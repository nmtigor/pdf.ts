...
export class RadialAxialShadingPattern {
    _type;
    _bbox;
    _colorStops;
    _p0;
...
export var TilingPaintType;
(function (TilingPaintType) {
    TilingPaintType[TilingPaintType["COLORED"] = 1] = "COLORED";
    TilingPaintType[TilingPaintType["UNCOLORED"] = 2] = "UNCOLORED";
})(TilingPaintType || (TilingPaintType = {}));
export var TilingType;
(function (TilingType) {
    ...
    setFillAndStrokeStyleToContext(graphics, paintType, color) {
        ...
        switch (paintType) {
            case TilingPaintType.COLORED:
                ...
                break;
            case TilingPaintType.UNCOLORED:

 ...
 * @license Apache-2.0
 ******************************************************************************/
import { div, html as createHTML, span, svg as createSVG, textnode, } from "../../../lib/dom.js";
...
import { DOMSVGFactory, PDFDateString, setLayerDimensions, } from "./display_utils.js";
    ...
    _setEventListeners(element, elementData, names, getter) {
        for (const [baseName, eventName] of names) {
            if (eventName === "Action" ||
                ...
                this.#setEventListener(element, elementData, baseName, eventName, getter);
...
class CheckboxWidgetAnnotationElement extends WidgetAnnotationElement {
    ...
    render() {
        ...
        if (this.enableScripting && this.hasJSActions) {
            ...
            this._setEventListeners(element, undefined, [
                ["change", "Validate"],
                ["change", "Action"],
                ["focus", "Focus"],
                ["blur", "Blur"],
...
class ChoiceWidgetAnnotationElement extends WidgetAnnotationElement {
    ...
    render() {
        ...
        if (this.enableScripting && this.hasJSActions) {
            ...
            this._setEventListeners(selectElement, undefined, [
                ["focus", "Focus"],
                ["blur", "Blur"],
                ["mousedown", "Mouse Down"],
                ["mouseenter", "Mouse Enter"],
    ...
    render() {
        ...
        if (this.#color) {
            ...
            if (MOZCENTRAL ||
                ...
                popup.style.backgroundColor = Util.makeHexColor(...rgb_);
            }
        }
        const header = span();
...
export class AnnotationLayer {
    ...
    #appendElement(element, id) {
        ...
        this.#accessibilityManager?.moveElementInDOM(this.div, element, contentElement, 
        /* isRemovable = */ false);
    }
    /**

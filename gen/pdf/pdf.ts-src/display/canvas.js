...
export class CanvasGraphics {
    ...
    transparentCanvas;
    pendingTextPaths;
    constructor(canvasCtx, commonObjs, objs, canvasFactory, filterFactory, { optionalContentConfig, markedContentStack = undefined }, annotationCanvasMap, pageColors) {
        this.ctx = canvasCtx;
    ...
    _createMaskCanvas(img) {
        ...
        if ((img.bitmap || img.data) && img.count > 1) {
            ...
            cacheKey = JSON.stringify(isPatternFill
                ? currentTransform
        ...
        if (backdrop) {
            if (maskX < 0 ||
                ...
                if (backdrop.some((c) => c !== 0)) {
                    ...
                    ctx.fillStyle = Util.makeHexColor(backdrop[0], backdrop[1], backdrop[2]);
                ...
                maskCtx.fillStyle = Util.makeHexColor(backdrop[0], backdrop[1], backdrop[2]);
    ...
    [OPS.paintInlineImageXObject](imgData) {
        ...
        else if ((typeof HTMLElement === "function" && imgData instanceof HTMLElement) ||
            !imgData.data) {

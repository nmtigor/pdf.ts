...
(function (Ns_calculateMD5) {
    ...
    Ns_calculateMD5.hash = hash;
})(Ns_calculateMD5 || (Ns_calculateMD5 = {}));
export var calculateMD5 = Ns_calculateMD5.hash;
/** @final */
class Word64 {
    high;
    low;
...
var Ns_calculateSHA256;
(function (Ns_calculateSHA256) {
    function rotr(x, n) {
        return (x >>> n) | (x << (32 - n));
    }
    function ch(x, y, z) {
    ...
    Ns_calculateSHA256.hash = hash;
})(Ns_calculateSHA256 || (Ns_calculateSHA256 = {}));
export var calculateSHA256 = Ns_calculateSHA256.hash;
var Ns_calculateSHA512;
(function (Ns_calculateSHA512) {
    ...
    Ns_calculateSHA512.hash = hash;
})(Ns_calculateSHA512 || (Ns_calculateSHA512 = {}));
export var calculateSHA512 = Ns_calculateSHA512.hash;
export function calculateSHA384(data, offset, length) {
...
class AESBaseCipher {
    ...
    decryptBlock = (data, finalize, iv = undefined) => {
        const sourceLength = data.length;
...
export var PDF20 = NsPDF20.PDF20;

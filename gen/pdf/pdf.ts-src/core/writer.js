...
export async function writeDict(dict, buffer, transform) {
    buffer.push("<<");
...
async function updateAcroform({ xref, acroForm, acroFormRef, hasXfa, hasXfaDatasetsEntry, xfaDatasetsRef, needAppearances, newRefs, }) {

...
export var Errors;
(function (Errors) {
    Errors["assignment"] = "Invalid token in assignment.";
    Errors["block"] = "Invalid token in do ... end declaration.";
    Errors["elseif"] = "Invalid elseif declaration.";
    Errors["for"] = "Invalid token in for ... endfor declaration.";
    Errors["foreach"] = "Invalid token in foreach ... endfor declaration.";
    Errors["func"] = "Invalid token in func declaration.";
    Errors["if"] = "Invalid token if ... endif declaration.";
    Errors["index"] = "Invalid token in index.";
    Errors["params"] = "Invalid token in parameter list.";
    Errors["var"] = "Invalid token in var declaration.";
    Errors["while"] = "Invalid token while ... endwhile declaration.";
})(Errors || (Errors = {}));
...
class AstBinaryOperator extends Leaf {
    ...
    static getOperatorOrValue(operator, left, right) {
        ...
        if (Operators.lt.id <= operator.id &&
...
/*80--------------------------------------------------------------------------*/
//# sourceMappingURL=formcalc_parser.js.map
...
type PropValueEx = XFAProp | XFAObject[] | XFAAttribute | XFAObject | XFAObjectArray;
export declare abstract class XFAObject {
    ...
    get isXFAObject(): boolean;
    get isXFAObjectArray(): boolean;
    createNodes(path: Parsed[]): XmlObject | undefined;

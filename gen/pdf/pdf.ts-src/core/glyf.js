...
class SimpleGlyph {
    ...
    static parse(pos, glyf, numberOfContours) {
        ...
        pos += 2;
        const instructions = new Uint8Array(glyf.buffer).slice(pos, pos + instructionLength);
...
class CompositeGlyph {
    ...
    transf;
    instructions;
    constructor({ flags, glyphIndex, argument1, argument2, transf, instructions, }) {
        this.flags = flags;

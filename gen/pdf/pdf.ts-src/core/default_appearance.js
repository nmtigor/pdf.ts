...
export function parseAppearanceStream(stream, evaluatorOptions, xref) {
...
endcmap CMapName currentdict /CMap defineresource pop end end`;
    ...
    get fontDescriptorRef() {
        if (!FakeUnicodeFont.#fontDescriptorRef) {
            ...
            FakeUnicodeFont.#fontDescriptorRef = this.xref.getNewPersistentRef(fontDescriptor);
        }
    ...
    createAppearance(text, rect, rotation, fontSize, bgColor, strokeAlpha) {
        ...
        const buffer = [
            ...
            `BT`,
            `1 0 0 1 0 ${numberToString(h + lineDescent)} Tm 0 Tc ${getPdfColor(bgColor, 
            /* isFill */ true)}`,

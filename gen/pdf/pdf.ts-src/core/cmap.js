...
var NsBinaryCMapReader;
(function (NsBinaryCMapReader) {
    ...
    NsBinaryCMapReader.BinaryCMapReader = BinaryCMapReader;
})(NsBinaryCMapReader || (NsBinaryCMapReader = {}));
var BinaryCMapReader = NsBinaryCMapReader.BinaryCMapReader;
var NsCMapFactory;
(function (NsCMapFactory) {
    ...
    NsCMapFactory.CMapFactory = {
        async create(params) {
            ...
            if (encoding instanceof Name) {
                ...
                /* cMap = */ new CMap(), 
                /* lexer = */ new Lexer(encoding), fetchBuiltInCMap, useCMap);

...
(function (NsJpxImage) {
    ...
    NsJpxImage.LayerResolutionComponentPositionIterator = LayerResolutionComponentPositionIterator;
    ...
    NsJpxImage.ResolutionLayerComponentPositionIterator = ResolutionLayerComponentPositionIterator;
    ...
    NsJpxImage.ResolutionPositionComponentLayerIterator = ResolutionPositionComponentLayerIterator;
    ...
    NsJpxImage.PositionComponentResolutionLayerIterator = PositionComponentResolutionLayerIterator;
    ...
    NsJpxImage.ComponentPositionResolutionLayerIterator = ComponentPositionResolutionLayerIterator;
    ...
    NsJpxImage.InclusionTree = InclusionTree;
    ...
    class BitModel {
            ...
            for (let i0 = 0; i0 < height; i0 = iNext) {
                ...
                for (let j = 0; j < width; j++) {
                    ...
                    if (allEmpty) {
                        ...
                        i1 = (decoder.readBit(contexts, BitModel.UNIFORM_CONTEXT) << 1) |
        ...
        checkSegmentationSymbol() {
            const decoder = this.decoder;
            const contexts = this.contexts;
            const symbol = (decoder.readBit(contexts, BitModel.UNIFORM_CONTEXT) << 3) |

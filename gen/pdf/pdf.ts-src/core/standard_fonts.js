 ...
 */
export const getStdFontMap = getLookupTableFactory((t) => {
 ...
 */
export const getNonStdFontMap = getLookupTableFactory((t) => {
    t.Calibri = "Helvetica";
...
export const getSerifFonts = getLookupTableFactory((t) => {
    t["Adobe Jenson"] = true;
    t["Adobe Text"] = true;
    t.Albertus = true;
    t.Aldus = true;
...
export const getSymbolsFonts = getLookupTableFactory((t) => {
    t.Dingbats = true;
    t.Symbol = true;
    t.ZapfDingbats = true;
    t.Wingdings = true;
...
export function getStandardFontName(name) {
    const fontName = normalizeFontName(name);
    const stdFontMap = getStdFontMap();
    return stdFontMap[fontName];
}
export function isKnownFontName(name) {
    const fontName = normalizeFontName(name);
    return !!(getStdFontMap()[fontName] ||

...
(function (NsJbig2Image) {
            ...
            while (true) {
                ...
                if (refinement) {
                    ...
                    if (numberOfInstances > 1) {
                        ...
                        symbols.concat(newSymbols), symbolCodeLength, false, // transposed
                        0, // ds offset
    ...
    NsJbig2Image.HuffmanTable = HuffmanTable;
    ...
    const standardTablesCache = Object.create(null);

...
(function (NsJpegImage) {
                    ...
                    if (nextByte === /* DNL = */ 0xdc && parseDNLMarker) {
                        ...
                        if (parseDNLMarker) {
                            ...
                            if (maybeScanLines > 0 &&
                                ...
                                throw new DNLMarkerError("Found EOI marker (0xFFD9) while parsing scan data, " +
    ...
    class JpegImage {
        ...
        components;
        numComponents;
        constructor({ decodeTransform, colorTransform = -1 } = {}) {
            ...
            markerLoop: while (fileMarker !== /* EOI (End of Image) = */ 0xffd9) {
                ...
                switch (fileMarker) {
                    ...
                    case 0xffc2: // SOF2 (Start of Frame, Progressive DCT)
                        ...
                        offset += 2;
                        frame.components = [];
                        frame.componentIds = Object.create(null);
        ...
        #getLinearizedBlockData = (width, height, isSourcePDF = false) => {
        ...
        get #isColorConversionNeeded() {
            ...
            if (this.numComponents === 3) {
                ...
                else if (this.components[0].index === /* "R" = */ 0x52 &&

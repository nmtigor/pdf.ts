...
import type { AnnotIntent, DocumentInitP, GetTextContentP, Intent, OutlineNode, PDFDocumentLoadingTask, PDFDocumentProxy, PDFPageProxy, RefProxy, RenderP, RenderTask, TextContent, TextItem } from "./display/api.js";

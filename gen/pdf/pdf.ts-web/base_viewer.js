...
export class BaseViewer {
    ...
    /** @implement */
    createAnnotationEditorLayerBuilder({ uiManager = this.#annotationEditorUIManager, pageDiv, pdfPage, l10n, annotationStorage = this.pdfDocument?.annotationStorage, }) {

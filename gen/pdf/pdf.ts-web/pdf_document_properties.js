...
export class PDFDocumentProperties {
    ...
    async open() {
        ...
        const { info, 
        /* metadata, */
        contentDispositionFilename, contentLength, } = await this.pdfDocument.getMetadata();
    ...
    async #parsePageSize(pageSizeInches, pagesRotation) {
        ...
        const [{ width, height }, unit, name, orientation] = await Promise.all([
            ...
            this.l10n.get(`document_properties_page_size_unit_${this.#isNonMetricLocale ? "inches" : "millimeters"}`),
            rawName &&
...
/*81---------------------------------------------------------------------------*/
//# sourceMappingURL=pdf_document_properties.js.map
...
function o(t = {}) {
    var r;
    return null ===
        (r = Object.entries(t).find(([t]) => t.toLowerCase() === e.toLowerCase())) || void 0 === r
        ? void 0
        : r[1];
}
function n(e) {
...
const l = (e) => {
    ...
    e = e._addons.reduce((t, r) => r.beforeRequest && r.beforeRequest(t, e._options, o) || t, e);
    const { _url: n, _options: i, _config: l, _catchers: a, _resolvers: u, _middlewares: h, _addons: f, } = e, d = new Map(a), p = s(l.options, i);
    let _ = n;
    const y = ((e) => (t) => e.reduceRight((e, t) => t(e), t) || t)(h)((e, t) => (_ = e, l.polyfill("fetch")(e, t)))(n, p), g = new Error(), m = y.catch((e) => {
        throw { [t]: e };
    }).then((e) => {
        if (!e.ok) {
            const t = new c();
        ...
        const n = o.hasOwnProperty(t), s = n ? o[t] : o, i = (null == s ? void 0 : s.status) && d.get(s.status) ||
    ...
    fetch(e = this._options.method, t = "", r = null) {
        ...
        const i = o(s._options.headers), c = this._config.polyfill("FormData", 0), a = "object" == typeof r && !(c && r instanceof c) &&
    ...
    json(e, t) {
        ...
        return this.content(t || n(r) && r || "application/json").body(JSON.stringify(e));
    },
}, u = () => ({
    beforeRequest(e, t, r) {
...
const f = (e) => (t) => (r, o) => {
    ...
    if ((null == s ? void 0 : s.username) || (null == s ? void 0 : s.password)) {
        const e = h(`${decodeURIComponent(s.username)}:${decodeURIComponent(s.password)}`);
...
const g = {
    ...
    return {
        resolver: {
            perfs(o) {
                return this._fetchReq.then((n) => ((o, n, s) => {
                    if (!o || !n)
                        return;
                    ...
                    ((o, n) => (!t && o && n && (t = new n((t) => {
                        ...
                        (r(i, o, n, i) ||
                            (e.size < 1 &&
                                ...
                                e.set(o, n)));
                })(this._wretchReq._url, o, this._wretchReq._config)).catch(() => { }),
                    this;
            },
        },
    };

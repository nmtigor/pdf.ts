...
const l = (t) => {
    ...
    const { _url: s, _options: i, _config: l, _catchers: u, _resolvers: c, _middlewares: a, _addons: f, } = t, d = new Map(u), p = n(l.options, i);
    let _ = s;
    const y = ((t) => (e) => t.reduceRight((t, e) => e(t), e) || e)(a)((t, e) => (_ = t, l.polyfill("fetch")(t, e)))(s, p), b = new Error(), w = y.catch((t) => {
        throw { [e]: t };
    }).then((t) => {
        if (!t.ok) {
            const e = new h();
        ...
        const s = o.hasOwnProperty(e), n = s ? o[e] : o, i = (null == n ? void 0 : n.status) && d.get(n.status) ||
    ...
    fetch(t = this._options.method, e = "", r = null) {
        ...
        const i = o(n._options.headers), h = this._config.polyfill("FormData", 0), u = "object" == typeof r && !(h && r instanceof h) &&

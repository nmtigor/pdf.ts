...
const l = (e) => {
    ...
    e = e._addons.reduce((t, r) => r.beforeRequest && r.beforeRequest(t, e._options, n) || t, e);
    const { _url: o, _options: i, _config: l, _catchers: a, _resolvers: u, _middlewares: h, _addons: f, } = e, d = new Map(a), p = s(l.options, i);
    let _ = o;
    const y = ((e) => (t) => e.reduceRight((e, t) => t(e), t) || t)(h)((e, t) => (_ = e, l.polyfill("fetch")(e, t)))(o, p), g = new Error(), m = y.catch((e) => {
        throw { [t]: e };
    }).then((e) => {
        if (!e.ok) {
            const t = new c();
        ...
        const o = n.hasOwnProperty(t), s = o ? n[t] : n, i = (null == s ? void 0 : s.status) && d.get(s.status) ||
    ...
    fetch(e = this._options.method, t = "", r = null) {
        ...
        const i = n(s._options.headers), c = this._config.polyfill("FormData", 0), a = "object" == typeof r && !(c && r instanceof c) &&
    ...
    json(e, t) {
        ...
        return this.content(t || o(r) && r || "application/json").body(JSON.stringify(e));
    },
}, u = () => ({
    beforeRequest(e, t, r) {
...
const g = {
    ...
    return {
        resolver: {
            perfs(n) {
                return this._fetchReq.then((o) => ((n, o, s) => {
                    if (!n || !o)
                        return;
                    ...
                    ((n, o) => (!t && n && o && (t = new o((t) => {
                        ...
                        (r(i, n, o, i) ||
                            (e.size < 1 &&
                                ...
                                e.set(n, o)));
                })(this._wretchReq._url, n, this._wretchReq._config)).catch(() => { }),
                    this;
            },
        },
    };

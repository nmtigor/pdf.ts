...
const u = (t) => {
    ...
    const { _url: s, _options: i, _config: u, _catchers: l, _resolvers: c, _middlewares: a, _addons: d, } = t, f = new Map(l), p = n(u.options, i);
    let _ = s;
    ...
    fetch(t = this._options.method, e = "", r = null) {
        ...
        const i = o(n._options.headers), h = this._config.polyfill("FormData", 0), l = "object" == typeof r && !(h && r instanceof h) &&

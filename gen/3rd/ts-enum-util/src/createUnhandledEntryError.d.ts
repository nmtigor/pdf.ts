 ...
 * value was encountered.
 */
export declare function createUnhandledEntryError(unhandledValue: string | number | null | undefined): Error;
//# sourceMappingURL=createUnhandledEntryError.d.ts.map
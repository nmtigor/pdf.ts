...
export function datetimeRegex(args: any): RegExp;
...
export var z: Readonly<{
    ...
    datetimeRegex: typeof datetimeRegex;
...
export class ZodBigInt extends ZodType {
    constructor(...args: any[]);
    min: (value: any, message: any) => ZodBigInt;
    max: (value: any, message: any) => ZodBigInt;
    _parse(input: any): Readonly<{
        status: "aborted";
    }> | {
        status: string;
    ...
    gte(value: any, message: any): ZodBigInt;
    gt(value: any, message: any): ZodBigInt;
    lte(value: any, message: any): ZodBigInt;
    lt(value: any, message: any): ZodBigInt;
    setLimit(kind: any, value: any, inclusive: any, message: any): ZodBigInt;
    _addCheck(check: any): ZodBigInt;
    positive(message: any): ZodBigInt;
    negative(message: any): ZodBigInt;
    nonpositive(message: any): ZodBigInt;
    nonnegative(message: any): ZodBigInt;
    multipleOf(value: any, message: any): ZodBigInt;
    get minValue(): any;
    get maxValue(): any;
}
...
export class ZodEnum extends ZodType {
    ...
    get Values(): {};
    get Enum(): {};
    extract(values: any, newDef?: any): ZodEnum;
    exclude(values: any, newDef?: any): ZodEnum;
}
...
export namespace ZodReadonly {
    function create(type: any, params: any): ZodReadonly;
}
...
export class ZodString extends ZodType {
    ...
    emoji(message: any): ZodString;
    uuid(message: any): ZodString;
    nanoid(message: any): ZodString;
    cuid(message: any): ZodString;
    cuid2(message: any): ZodString;
    ulid(message: any): ZodString;
    base64(message: any): ZodString;
    ip(options: any): ZodString;
    datetime(options: any): ZodString;
    date(message: any): ZodString;
    time(options: any): ZodString;
    duration(message: any): ZodString;
    regex(regex: any, message: any): ZodString;
    includes(value: any, options: any): ZodString;

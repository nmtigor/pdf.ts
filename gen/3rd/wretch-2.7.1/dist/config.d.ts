 ...
 */
export function setOptions(options: any, replace?: boolean): void;
/**
 ...
 */
export function setPolyfills(polyfills: any, replace?: boolean): void;
/**
 ...
 */
export function setErrorType(errorType: any): void;
export default config;
declare namespace config {
    let options: {};
    let errorType: string;
    let polyfills: {};
    function polyfill(p: any, doThrow?: boolean, instance?: boolean, ...args: any[]): any;
}

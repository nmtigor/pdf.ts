...
function o(e = {}) {
    var r;
    return null ===
        (r = Object.entries(e).find(([e]) => e.toLowerCase() === t.toLowerCase())) || void 0 === r
        ? void 0
        : r[1];
}
function s(t) {
...
const u = (t) => {
    ...
    t = t._addons.reduce((e, r) => r.beforeRequest && r.beforeRequest(e, t._options, o) || e, t);
    const { _url: s, _options: i, _config: u, _catchers: c, _resolvers: l, _middlewares: a, _addons: d, } = t, f = new Map(c), p = n(u.options, i);
    let _ = s;
    const y = ((t) => (e) => t.reduceRight((t, e) => e(t), e) || e)(a)((t, e) => (_ = t, u.polyfill("fetch")(t, e)))(s, p), b = new Error(), w = y.catch((t) => {
        throw { [e]: t };
    }).then((t) => {
        if (!t.ok) {
            const e = new h();
        ...
        const s = o.hasOwnProperty(e), n = s ? o[e] : o, i = (null == n ? void 0 : n.status) && f.get(n.status) ||
    ...
    }, m = d.reduce((t, e) => ({ ...t, ...e.resolver }), j);
    return l.reduce((e, r) => r(e, t), m);
}, c = {
    _url: "",
    _options: {},
    _config: i,
    ...
    fetch(t = this._options.method, e = "", r = null) {
        ...
        const i = o(n._options.headers), h = "object" == typeof r && (!n._options.headers || !i || s(i));
        return n = r ? h ? n.json(r, i) : n.body(r) : n,
    ...
    json(t, e) {
        ...
        return this.content(e || s(r) && r || "application/json").body(JSON.stringify(t));
    },
};
function l(t = "", e = {}) {
    return { ...c, _url: t, _options: e };
}
l.default = l,
    l.options = function (t, e = 0) {
        i.options = e ? t : n(i.options, t);
    },
    l.errorType = function (t) {
        i.errorType = t;
    },
    l.polyfills = function (t, e = 0) {

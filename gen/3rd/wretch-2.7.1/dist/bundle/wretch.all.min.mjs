...
const l = (e) => {
    ...
    let _ = o;
    const y = ((e) => (t) => e.reduceRight((e, t) => t(e), t) || t)(h)((e, t) => (_ = e, l.polyfill("fetch")(e, t)))(o, p), g = new Error(), b = y.catch((e) => {
        throw { [t]: e };
    }).then((e) => {
        if (!e.ok) {
            const t = new c();
    ...
    fetch(e = this._options.method, t = "", r = null) {
        ...
        const i = n(s._options.headers), c = "object" == typeof r && (!s._options.headers || !i || o(i));

export function throttlingCache({ throttle: r, skip: s, key: a, clear: h, invalidate: i, condition: l, flagResponseOnCacheHit: f }?: {
...
//# sourceMappingURL=throttlingCache.min.d.cts.map
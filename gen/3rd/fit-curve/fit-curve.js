 ...
 */
function generateBezier(points, parameters, leftTangent, rightTangent, progressCallback) {
...
function newtonRaphsonRootFind(bez, point, u) {
    ...
    */
    var d = maths.subtract(bezier.q(bez, u), point), qprime = bezier.qprime(bez, u), numerator = maths.mulMatrix(d, qprime), denominator = maths.sum(maths.squareItems(qprime)) +
...
/*81---------------------------------------------------------------------------*/
//# sourceMappingURL=fit-curve.js.map
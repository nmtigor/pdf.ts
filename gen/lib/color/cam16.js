 ...
 * @license Apache-2.0
 ******************************************************************************/
import { argbFromXyz, linearized } from "./color_utils.js";
import { signum } from "./math_utils.js";
...
export class Cam16 {
    ...
    #set(hue, chroma, j, q, m, s, jstar, astar, bstar) {
        this.hue = hue;
        this.chroma = chroma;
        this.j = j;
        this.q = q;
     ...
     *     conditions.
     */
    static fromInt(argb, out_x) {
        return Cam16.fromIntInViewingConditions(argb, ViewingConditions.DEFAULT, out_x);
    }
    /**
     * @param argb ARGB representation of a color.
     ...
     * @return CAM16 color.
     */
    static fromIntInViewingConditions(argb, viewingConditions, out_x) {
     ...
     * @out @param out_x
     */
    static fromJch(j, c, h, out_x) {
        return Cam16.fromJchInViewingConditions(j, c, h, ViewingConditions.DEFAULT, out_x);
    }
    /**
     ...
     * @out @param out_x
     */
    static fromJchInViewingConditions(j, c, h, viewingConditions, out_x) {
        const q = (4.0 / viewingConditions.c) * Math.sqrt(j / 100.0) *
            (viewingConditions.aw + 4.0) * viewingConditions.fLRoot;
        const m = c * viewingConditions.fLRoot;
     ...
     * @out @param out_x
     */
    static fromUcs(jstar, astar, bstar, out_x) {
        return Cam16.fromUcsInViewingConditions(jstar, astar, bstar, ViewingConditions.DEFAULT, out_x);
    }
    /**
     * @param jstar CAM16-UCS lightness.
     * @param astar CAM16-UCS a dimension. Like a* in L*a*b*, it is a Cartesian
     ...
     * @out @param out_x
     */
    static fromUcsInViewingConditions(jstar, astar, bstar, viewingConditions, out_x) {
        const a = astar;
        const b = bstar;
